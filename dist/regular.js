...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers__ = __webpack_require__(68);
...
var range = __WEBPACK_IMPORTED_MODULE_1__helpers__["a" /* default */].range,
    initArray = __WEBPACK_IMPORTED_MODULE_1__helpers__["a" /* default */].initArray,
    cacheFn = __WEBPACK_IMPORTED_MODULE_1__helpers__["a" /* default */].cacheFn;
...
var mousedrag = __WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.fromEvent(c, 'mousedown').flatMap(function (md) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.merge(__WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.interval(100).map(function (el) {
    return null;
  }), __WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.fromEvent(c, 'mousemove')).map(function (mm) {
    ev = mm || ev;
    ...
    return [coorX, coorY];
  }).takeUntil(__WEBPACK_IMPORTED_MODULE_0_rxjs___default.a.Observable.fromEvent(c, 'mouseup'));
}).throttleTime(50).subscribe(function (_ref3) {
...
var _ref5 = [initGrid(WIDTH, HEIGHT, 0), initGrid(WIDTH, HEIGHT, 0)],
    grid = _ref5[0],
    buffer = _ref5[1];
...
GRID_COORS.forEach(function (_ref6) {
...
function getNeighborCoors(grid, x, y) {
  return DIR.reduce(function (acc, _ref8) {
...
var getCacheNeighborCoors = cacheFn(getNeighborCoors, NEIGHBOR_COORS_CACHE, function (_, x, y) {
  return x + ':' + y;
});
...
function countNeighborsAlive(grid, x, y) {
  ...
  return neighbors.reduce(function (acc, _ref10) {
...
function render(ctx, grid) {
  ...
  GRID_COORS.forEach(function (_ref14) {
